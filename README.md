...
| مشتری تأییدشده | `customer@ideban.test` | `123456` |
| مشتری در انتظار تأیید | `pending@ideban.test` | `123456` |
...
پنل مشتری در `/portal` است: ثبت‌نام، پروفایل، سفارش، پیام و تیکت برای فروش، پشتیبانی و مدیریت. دیتابیس موجود را با `portal-upgrade.sql` به‌روز کنید، نه با ایمپورت دوبارهٔ دامپ کامل.
